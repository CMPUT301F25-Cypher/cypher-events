...
public class enterant_actions_test {
    ...
    public void add_enterant_event_test() {
        ...
        assertTrue(his.contains("301Class"));
    ...
    public void remove_enterant_event_test() {
        ...
        ArrayList<Map<String, Object>> event = new ArrayList<>();
        ArrayList<String> his = new ArrayList<>();
        actions.add_enterant_to_event_array(event, "Bruce", "Bruce@gmail.com", 12345, "301Class", his,"301Class310");
        actions.add_enterant_to_event_array(event, "Peter", "peter@gmail.com", 23456, "301Class", his,"301Class310");
        assertEquals(2, event.size());
        actions.remove_enterant_to_event_array(event, "Bruce", "Bruce@gmail.com", 12345, "301Class", his);
        assertEquals(1, event.size());
