...
public class ViewInvitedEnterantFragments extends Fragment {
    public ViewInvitedEnterantFragments(){

    }
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstances){
        return inflater.inflate(R.layout.viewinvitedenterant,container,false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ListView Invitedenrolled = view.findViewById(R.id.InvitedentListView);
        Invitedenrolled .setAdapter(adapter);
    }
