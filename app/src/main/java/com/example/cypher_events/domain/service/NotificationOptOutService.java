 ...
 * This implementation locates the entrant doc by querying Entrant_id field (safe if doc key unknown).
 */
public class NotificationOptOutService {
     ...
     * Finds the Firestore document where field "Entrant_id" == entrantId and updates it (merge).
     */
